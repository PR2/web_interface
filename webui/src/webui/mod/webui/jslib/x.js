...
var xVersion='3.15.3',xNN4,xOp7,xOp5or6,xIE4Up,xIE4,xIE5,xIE6,xMac,xUA=navigator.userAgent.toLowerCase();
if (window.opera){
...
function xEvent(evt) {
  ...
  this.keyCode = 0;
  this.shiftKey = this.altKey = this.ctrlKey = 0;
